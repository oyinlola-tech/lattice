...
export interface ConfigurationErrorOptions
  ...
  /**
   * Name of the configuration key involved in the failure.
   *
  ...
  /**
   * Component or subsystem that owns the configuration.
   */
...
export class ConfigurationError
  ...
  /**
   * Returns a serialized representation with configuration diagnostics.
   */
