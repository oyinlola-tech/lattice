 ...
 */
export interface BodyParserErrorOptions
 ...
 */
export class UnsupportedBodyTypeError
  extends BodyParserError {
  /**
  ...
  constructor(
    ...
    super(
      ...
      {
        code:
          ErrorCode.HTTP_UNSUPPORTED_BODY_TYPE,
        metadata: {
          contentType,
        },
      },
 ...
 */
export class InvalidContentLengthError
  extends BodyParserError {
  /**
  ...
  constructor(
    ...
    super(
      ...
      {
        code:
          ErrorCode.HTTP_INVALID_CONTENT_LENGTH,
        metadata: {
          value,
        },
      },
