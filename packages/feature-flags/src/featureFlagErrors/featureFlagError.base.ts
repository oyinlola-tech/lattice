...
import { ApplicationError, ErrorCode } from "@lattice/errors";
import type { ErrorCategory, ErrorSeverity, ErrorMetadata } from "@lattice/errors";
 ...
 * Extends ApplicationError from @lattice/errors.
 */
