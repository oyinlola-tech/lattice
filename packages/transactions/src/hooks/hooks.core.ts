...
import type { TransactionHooks, TransactionHookContext, TransactionErrorContext } from "../transactionTypes/transactionHooks.js";

/**
 * Merge multiple hook sets into one. Later hooks run after earlier ones.
 */
export function mergeHooks(...hookSets: readonly TransactionHooks[]): TransactionHooks {
