...
export interface OpenAPIOperation {
  ...
  readonly callbacks?: Readonly<
    Record<string, Readonly<Record<string, OpenAPIPathItem>>>
  >;
...
export type OpenAPIResponses = Readonly<
  Record<string, import("./openApiComponent.type.js").OpenAPIResponse>
>;
...
export interface OpenAPIParameter {
  ...
  readonly examples?: Readonly<
    Record<string, import("./openApiComponent.type.js").OpenAPIExample>
  >;
  readonly content?: Readonly<
    Record<string, import("./openApiComponent.type.js").OpenAPIMediaType>
  >;
}
