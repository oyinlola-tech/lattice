...
export class OpenAPIValidationError extends OpenAPIError {
  constructor(message: string, issues?: readonly unknown[], options?: Omit<OpenAPIErrorOptions, "code">) {
...
export class OpenAPIDocumentError extends OpenAPIError {
  constructor(message: string, options?: Omit<OpenAPIErrorOptions, "code">) {
