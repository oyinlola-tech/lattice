    ...
    >
{
  ...
  constructor(
    ...
    if (!delegate) {
      throw new TypeError(
        "A repository delegate is required.",
      );
    }
  ...
  public async upsert(
    ...
    if (
      ...
      throw new DatabaseError(
        `Upsert is not supported by ${this.modelName}.`,
      );
    }
  ...
  protected async execute<TResult>(
    ...
    if (
      ...
      throw new DatabaseError(
        `${this.modelName} ${operation} was aborted.`,
      );
    }
  ...
  protected validateId(
    ...
    if (
      ...
      throw new DatabaseError(
        `${this.modelName} identifier is required.`,
      );
    }
  }
  ...
  protected validateFilter(
    ...
    if (
      ...
      throw new DatabaseError(
        `${this.modelName} filter is required.`,
      );
    }
  }
