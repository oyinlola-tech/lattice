...
- [`339a1d1`](https://github.com/oyinlola-tech/zudolib/commit/339a1d12ad475b50704d6fc30c6196441561ce4e) Thanks [@oyinlola-tech](https://github.com/oyinlola-tech)! - Security: override mysql2 transitive dependency to ^3.22.0 to fix credential disclosure vulnerability (mysql_clear_password auth switch without TLS).
