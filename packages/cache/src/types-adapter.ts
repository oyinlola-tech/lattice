...
import type { CacheClearOptions, CacheDeleteManyOptions, CacheDeleteOptions, CacheGetManyOptions, CacheGetOptions, CacheHasOptions, CacheKeysOptions, CacheSetManyOptions, CacheSetOptions } from "./types-operations.js";
...
export interface CacheAdapter {
  ...
  get<TValue = unknown>(key: CacheKey, options?: CacheGetOptions): Promise<CacheGetResult<TValue>>;
  set<TValue = unknown>(key: CacheKey, value: TValue, options?: CacheSetOptions): Promise<CacheSetResult>;
  delete(key: CacheKey, options?: CacheDeleteOptions): Promise<CacheDeleteResult>;
  ...
  getMany?<TValue = unknown>(keys: readonly CacheKey[], options?: CacheGetManyOptions): Promise<ReadonlyMap<CacheKey, CacheGetResult<TValue>>>;
  setMany?<TValue = unknown>(entries: ReadonlyMap<CacheKey, TValue>, options?: CacheSetManyOptions): Promise<readonly CacheSetResult[]>;
  deleteMany?(keys: readonly CacheKey[], options?: CacheDeleteManyOptions): Promise<CacheDeleteManyResult>;
  ttl?(key: CacheKey, options?: CacheGetOptions): Promise<number | null>;
  expire?(key: CacheKey, ttl: CacheTTL, options?: CacheGetOptions): Promise<boolean>;
}
