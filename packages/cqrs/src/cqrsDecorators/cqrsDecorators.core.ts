 ...
 */
const CQRS_HANDLER_METADATA = Symbol.for("lattice.cqrs.handler");

/**
 * Metadata key used to identify command handler configuration.
 */
const COMMAND_HANDLER_METADATA = Symbol.for("lattice.cqrs.command-handler");

/**
 * Metadata key used to identify query handler configuration.
 */
const QUERY_HANDLER_METADATA = Symbol.for("lattice.cqrs.query-handler");

/**
 * Metadata key used to identify command/query type information.
 */
const CQRS_TYPE_METADATA = Symbol.for("lattice.cqrs.type");
