...
import {
  createLoggerEntry,
} from "../../../loggerEntry/loggerEntry.core.js";
...
export function createEntry(
  ...
  contextStorage: { get(): import("../../../loggerContext/loggerContext.core.js").LoggerContext | undefined },
  level: LoggerLevel,
  message: string,
  options: LogOptions,
): LoggerEntry {
  const activeContext =
    configuration.inheritContext
      ? contextStorage.get()
      : undefined;
  ...
  const input: LoggerEntryInput = {
    ...
    metadata,
    context: context
      ? { metadata: context.metadata as unknown as import("../../../loggerEntry/loggerEntry.type.js").LogMetadata }
      : undefined,
