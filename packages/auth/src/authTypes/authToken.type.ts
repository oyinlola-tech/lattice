...
import type { TokenId } from "@zudoliblib/constants";

/** JWT token string. */
export type JwtToken = string;

/** Token identifier. Re-exported from @zudoliblib/constants for type safety. */
export type { TokenId } from "@zudoliblib/constants";
