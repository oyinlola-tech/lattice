/**
 * Configuration schema and validation primitives for Lattice.
 *
 * Schemas describe the expected shape and type of configuration
 * values. Validation is intentionally dependency-free so the core
 * configuration package can remain lightweight.
 */
