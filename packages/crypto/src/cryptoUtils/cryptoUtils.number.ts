 ...
 */
export function numberToBytes(value: number, byteLength = 8): Uint8Array {
...
export function bytesToNumber(value: Uint8Array): number {
  if (value.byteLength === 0 || value.byteLength > 6) {
    throw new RangeError("Byte array length must be between 1 and 6.");
  }
