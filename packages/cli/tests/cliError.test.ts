...
describe("CommandNotFoundError", () => {
  it("extends NotFoundError from @zudoliblib/errors", () => {
...
describe("DuplicateCommandError", () => {
  it("extends ConflictError from @zudoliblib/errors", () => {
...
describe("CLIPermissionError", () => {
  it("extends AuthorizationError from @zudoliblib/errors", () => {
...
describe("CLIConfigurationError", () => {
  it("extends ConfigurationError from @zudoliblib/errors", () => {
