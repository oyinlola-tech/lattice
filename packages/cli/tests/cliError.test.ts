...
describe("CommandNotFoundError", () => {
  it("extends NotFoundError from @zudojs/errors", () => {
...
describe("DuplicateCommandError", () => {
  it("extends ConflictError from @zudojs/errors", () => {
...
describe("CLIPermissionError", () => {
  it("extends AuthorizationError from @zudojs/errors", () => {
...
describe("CLIConfigurationError", () => {
  it("extends ConfigurationError from @zudojs/errors", () => {
