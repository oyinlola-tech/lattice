/**
 * @zudoliblib/storage — JSON Serializer
 *
 * Serializes/deserializes data for storage with support for BigInt, Date,
 * Map, Set, and Uint8Array via @zudoliblib/serialization's type preservation.
 */
 ...
 *
 * Delegates to @zudoliblib/serialization's JSONSerializer for type preservation
