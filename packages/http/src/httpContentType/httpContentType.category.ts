...
export function isJSON(
  ...
  return (
    matchesContentType(value, "application/json") || isStructuredJSON(value)
  );
}
...
export function isStructuredJSON(
  ...
  return mediaType?.endsWith("+json") ?? false;
}
...
export function isXML(value: string | ContentType | undefined | null): boolean {
  const mediaType = getMediaType(value);
