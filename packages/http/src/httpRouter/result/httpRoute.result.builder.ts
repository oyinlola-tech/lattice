...
HttpRouteResult.prototype.withHeader =
  function (
    name:
      | string,
    value:
...
HttpRouteResult.prototype.withHeaders =
  function (
    headers:
      | HeadersInit,
  ):
...
HttpRouteResult.prototype.withBody =
  function (
    body:
      | RouteResultBody,
  ):
...
HttpRouteResult.prototype.withStatus =
  function (
    status:
      | number,
    statusText?:
...
HttpRouteResult.prototype.withMetadata =
  function (
    metadata:
      | Readonly<
