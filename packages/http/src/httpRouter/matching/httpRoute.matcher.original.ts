...
export interface RouteMatcherOptions {
  ...
  readonly allowHeadFallback?:
    | boolean;

  readonly allowOptionsFallback?:
    | boolean;
}
...
export class RouteMatcher {
  ...
  constructor(
    ...
    this.options = {
      ...
      allowHeadFallback:
        options.allowHeadFallback ??
        true,

      allowOptionsFallback:
        options.allowOptionsFallback ??
        true,
    };
  }
