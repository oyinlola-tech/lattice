...
export function formatEntityTag(
  tag:
    | EntityTag
    | string,
  weak = false,
...
export function isWildcardETag(
  value:
    | string
    | undefined
    | null,
...
export function normalizeHTTPDate(
  value:
    | Date
    | string,
): Date | undefined {
...
export function shouldReturnNotModified(
  ...
  return evaluateConditionalRequest(
    method,
    headers,
    resource,
  ).notModified;
