...
export class CookieCollection {
  ...
  public valuesIterator(): IterableIterator<
    string
  > {
...
export function parseCookies(
  ...
  for (
    const part of splitCookieHeader(
      header,
    )
  ) {
    const separator =
...
export function serializeCookie(
  ...
  if (
    ...
    if (
      ...
      throw new TypeError(
        "Cookie maxAge must be a finite number.",
      );
    }
  ...
  if (
    ...
    if (
      ...
      throw new TypeError(
        "Cookie expires must be a valid Date.",
      );
    }
...
export function signCookieValue(
  ...
  if (
    ...
    throw new TypeError(
      "Cookie signing secret cannot be empty.",
    );
  }
...
function normalizePriority(
  ...
  switch (
    ...
    default:
      throw new TypeError(
        `Invalid cookie priority: ${String(
          value,
        )}`,
      );
  }
