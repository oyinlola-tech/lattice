...
export class DefaultRuntimeBootstrap implements RuntimeBootstrap {
  ...
  public async bootstrap(
    ...
    try {
      ...
      const operation = executeBootstrapPipeline(
        configuration,
        errors,
        {
          incrementLoaded: () => {
  ...
  private resolveOptions(
    ...
    return {
      loadModules:
        options.loadModules ?? this._runtimeOptions.startup.autoLoadModules,
      initializeModules:
        options.initializeModules ??
        this._runtimeOptions.startup.autoInitializeModules,
      startModules:
        options.startModules ?? this._runtimeOptions.startup.autoStartModules,
