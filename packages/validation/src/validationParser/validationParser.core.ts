...
/**
 * Parses a value and returns a fallback produced by a function
...
/**
 * Parses multiple values using the same schema.
 *
 * The operation succeeds only when every value is valid.
 */
 ...
 *
 * Useful for validating maps of identifiers to values.
 */
 ...
 *
 * Undefined is accepted and returned as undefined.
 */
...
/**
 * Parses a nullable value.
 *
 * Null is accepted and returned as null.
 */
