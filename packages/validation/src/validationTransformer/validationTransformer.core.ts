 ...
 */
export type ValidationTransform<T, U> = (
  value: T,
) => U;
 ...
 */
export type AsyncValidationTransform<
  T,
  U,
> = (
  value: T,
 ...
 */
export interface AsyncValidationTransformer<
  T,
  U,
> {
  readonly name: string;
    ...
    transform(
      ...
      try {
        ...
        throw new ConstraintValidationError(
          options.transformErrorMessage ??
            "Validation transformation failed.",
          [],
          {
            cause: error,
          },
 ...
 */
export function createAsyncValidationTransformer<
  T,
  U,
>(
  transform: AsyncValidationTransform<
    T,
    U
  >,
  options: TransformerOptions = {},
 ...
 */
export async function validateAndTransformAsync<
  T,
  U,
>(
  schema: ValidationSchema<T>,
...
export function composeManyTransforms<T>(
  ...transforms: readonly ValidationTransform<
    T,
    T
  >[]
 ...
 *
 * This helper keeps the transformation operation separate from
 * schema construction so callers can compose validation behavior.
 */
