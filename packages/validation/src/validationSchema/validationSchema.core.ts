...
/**
 * Parses input using a schema and throws SchemaValidationError
 ...
 */
export function createAsyncParser<T>(
  schema: ValidationSchema<T>,
) {
  return (
    value: unknown,
...
/**
 * Re-exports Zod so consumers do not need to depend on a second
 * version of Zod when defining application schemas.
 */
export { z };