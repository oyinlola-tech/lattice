...
export function createEventType(
  ...
  if (
    ...
    throw new TypeError(
      "At least one event type segment is required.",
    );
  }
 ...
 * user
 */
export function getEventNamespace(
  type:
    EventType,
):
  string {
 ...
 */
export function getEventTypeSegments(
  type:
    EventType,
):
  readonly string[] {
 ...
 * namespace.
 */
export function isChildEventType(
  type:
    EventType,
  parent:
    EventType,
 ...
 * → "user.*"
 */
export function createEventTypePattern(
  namespace:
    string,
):
  EventTypePattern {
 ...
 */
export function defineEventTypes<
  const TMap extends EventPayloadMap,
>(
  map:
    TMap,
):
 ...
 */
export function tryNormalizeEventType(
  type:
    string,
):
  EventType |
