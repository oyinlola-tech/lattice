...
export function createArticleId(id: string): ArticleId { return id as ArticleId; }
export function createCommentId(id: string): CommentId { return id as CommentId; }
export function createReactionId(id: string): ReactionId { return id as ReactionId; }
export function createTopicId(id: string): TopicId { return id as TopicId; }
